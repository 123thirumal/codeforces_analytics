...
SECRET_KEY = 'django-insecure-!w=zlxxp83#z63=4-#&^*r+d$cv$ee2+f@^(oj_!3&o7^(na+f'
...
INSTALLED_APPS = [
    ...
    'users',  # Make sure this line is included
]
...
DATABASES = {
    'default': {
        ...
        'NAME': 'analytics_db',       # Replace with the name of your PostgreSQL database
        'USER': 'postgres',                 # Replace with your PostgreSQL username
        'PASSWORD': 'Thiru123',        # Replace with your PostgreSQL password
